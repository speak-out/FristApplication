...
public class ImageDetailsActivity extends Activity implements
	...
	public void onStart() {
		...
		Action viewAction = Action.newAction(
				...
				"ImageDetails Page", // TODO: Define a title for the content shown.
				// TODO: If you have web page content that matches this app activity's content,
				// make sure this auto-generated web page URL is correct.
				// Otherwise, set the URL to null.
				Uri.parse("http://host/path"),
				// TODO: Make sure this auto-generated app URL is correct.
				Uri.parse("android-app://com.example.yuer.fristapplication/http/host/path")
		);
...
//			Bitmap bitmap = ImageLoader.decodeSampledBitmapFromResource(Images.imageUrls[position],40);
//			if (bitmap == null) {
//				bitmap = BitmapFactory.decodeResource(getResources(),
//						R.drawable.empty_photo);
//			}
			View view = LayoutInflater.from(ImageDetailsActivity.this).inflate(
					R.layout.page_image_view, null);
...
//			Bitmap bitmap = com.nostra13.universalimageloader.core.ImageLoader.getInstance().loadImageSync(Images.imageUrls[position]);
			ImageLoader.getInstance().displayImage(Images.imageUrls[position], imageView);

//			ImageLoader.getInstance().loadImageSync(Images.imageUrls[position]);
